            ...
            <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="space-y-8 text-center lg:text-left">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <button className="px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-neutral-900 font-semibold rounded-lg hover:shadow-lg hover:shadow-amber-500/50 transition-all duration-300 hover:scale-105">
                            View My Work
                        </button>
                    ...
                    <div className="grid grid-cols-3 gap-6 pt-8">
                        <div className="text-center lg:text-left">
                            <div className="text-3xl md:text-4xl font-bold text-amber-400">3+</div>
                    ...
                    <div className="relative w-full max-w-lg mx-auto">
                        ...
                        <div className="absolute -bottom-6 -left-6 bg-neutral-900 border border-neutral-800 rounded-2xl p-4 shadow-xl backdrop-blur-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-neutral-300 font-medium">Available for work</span>
                            </div>
                        </div>
                    </div>
                </div>
